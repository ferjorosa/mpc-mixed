...
public class DataInstanceFromDataRow implements DataInstance, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DataInstanceFromDataRow that = (DataInstanceFromDataRow) o;
        return Arrays.equals(dataRow.toArray(), that.dataRow.toArray());
    }

    @Override
    public int hashCode() {
        return Arrays.hashCode(this.dataRow.toArray());
    }
}
