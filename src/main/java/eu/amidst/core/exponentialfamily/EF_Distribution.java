 ...
 */
/*
    MyNote: Para no tener metodos con UnsupportedOperationException, seria mejor que los metodos fueran en un interfaz que seria
    implementado solo por las distribuciones de aprendizaje
 */
public abstract class EF_Distribution implements Serializable {
     ...
     * @return a {@link AmidstVector} object.
     */
    public abstract AmidstVector createZeroVector();
     ...
     * This method can be then seen as a part of the model pre-processing for performing Bayesian learning.
     *
     *      * We pass the parameters of the prior distribution in array form. They will be internally transformed to natural form.
     *
     * <p> For example, if applied to a Multinomial distribution, this method will return a new conditional distribution with a
     * Dirichlet parent variable and an unconditional Dirichlet distribution. If applied to a Normal distribution, it
     * will return a new conditional distribution with Normal and Gamma parent variables and the associated Normal and
     ...
     * @return a non-empty {@code List} of {@link EF_ConditionalDistribution} objects.
     */
    protected List<EF_ConditionalDistribution> toExtendedLearningDistribution(ParameterVariables variables, String nameSuffix, double[] priorsParameters){
        throw new UnsupportedOperationException("Not convertible to Learning distribution");
    }
     ...
     * @return a non-empty {@code List} of {@link EF_ConditionalDistribution} objects.
     */
    public List<EF_ConditionalDistribution> toExtendedLearningDistribution(ParameterVariables variables, double[] priorsParameters){
        return this.toExtendedLearningDistribution(variables,"", priorsParameters);
    }
}