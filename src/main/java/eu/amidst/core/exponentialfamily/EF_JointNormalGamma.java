 ...
 */
// Natural parameters formula can be found in the table of: https://en.wikipedia.org/wiki/Exponential_family
// Moments of the distribution can be found in
public class EF_JointNormalGamma extends EF_UnivariateDistribution {
     ...
     * {@inheritDoc}
     */
    // Moments of the Normal-Gamma distribution can be found in https://en.wikipedia.org/wiki/Normal-gamma_distribution
    @Override
    ...
    public AmidstVector getExpectedParameters() {
        ...
        AmidstVector vec = new ArrayVector(2);
        vec.set(0,mean);
        vec.set(1,precision);
