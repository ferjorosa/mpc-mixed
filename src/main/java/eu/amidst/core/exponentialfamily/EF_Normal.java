...
public class EF_Normal extends EF_UnivariateDistribution {
    ...
    public AmidstVector getExpectedParameters() {
        AmidstVector vec = new ArrayVectorParameter(1);
    ...
    public List<EF_ConditionalDistribution> toExtendedLearningDistribution(ParameterVariables variables, String nameSuffix, double[] priorsParameters) {
        ...
        /* Creamos una nueva distribucion Normal-Gamma pasandole los parametros naturales iniciales */
        conditionalDistributions.add(varNormalGamma.getDistributionType().newEFUnivariateDistribution(priorsParameters));
