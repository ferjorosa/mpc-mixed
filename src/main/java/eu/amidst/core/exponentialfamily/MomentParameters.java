...
/**
 * This interface extends the interface {@link AmidstVector} and handles classes for representing the moment parameter vector
 ...
 */
public interface MomentParameters extends AmidstVector {
