...
/**
 * This interface extends the interface {@link AmidstVector} and handles classes for representing the natural parameter vector
 ...
 */
public interface NaturalParameters extends AmidstVector {
