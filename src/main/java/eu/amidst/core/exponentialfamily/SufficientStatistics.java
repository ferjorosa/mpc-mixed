...
/**
 * This interface extends the interface {@link AmidstVector} and handles classes for representing the sufficient statistics vector
 ...
 */
public interface SufficientStatistics extends AmidstVector {
