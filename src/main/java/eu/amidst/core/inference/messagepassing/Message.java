 ...
 */
public class Message<E extends AmidstVector> {
     ...
     */
    public static <E extends AmidstVector> Message<E> combineNonStateless(Message<E> m1, Message<E> m2){
...
//    }
     ...
     * @return the message that represents the result of the combination of the two input messages.
     */
    public static <E extends AmidstVector> Message<E> combineStateless(Message<E> m1, Message<E> m2){
        if (m1.getNode().getMainVariable()!=m2.getNode().getMainVariable()) {
            throw new IllegalArgumentException();
        }
