...
public interface AmidstVector {
     ...
     */
    default void sum(AmidstVector vector){
     ...
     * @param vector an input Vector.
     */
    default void substract(AmidstVector vector){
        if (this.size()!=vector.size())
            throw new IllegalArgumentException("Vectors do not have same size.");
     ...
     * @param vector an input Vector.
     */
    default void copy(AmidstVector vector){
        if (this.size()!=vector.size())
            throw new IllegalArgumentException("Vectors do not have same size.");
     ...
     */
    default double dotProduct(AmidstVector vector){
        if (this.size()!=vector.size())
            throw new IllegalArgumentException("Vectors do not have same size.");
     ...
     */
    default boolean equalsVector(AmidstVector vector, double threshold){
     ...
     */
    static AmidstVector sumVector(AmidstVector vec1, AmidstVector vec2){
        vec2.sum(vec1);
        return vec2;
    }
