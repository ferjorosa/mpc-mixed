...
public class CompoundVector implements MomentParameters, NaturalParameters, SufficientStatistics, Serializable {
     ...
     * @param vectors a {@code List} of {@link AmidstVector}s.
     */
    public CompoundVector(List<AmidstVector> vectors) {
     ...
     * @param vec the {@link AmidstVector} object to be set.
     */
     ...
     * @return the extracted {@link AmidstVector} object.
     */
     ...
     */
    public List<AmidstVector> getVectors(){
        List<AmidstVector> vectors = new ArrayList();
     ...
     */
    @Override
    public void substract(AmidstVector vector) {
    ...
    static class IndexedVector implements Serializable{
        ...
        /** Represents a {@link AmidstVector} object. */
        AmidstVector vector;
         ...
         */
        IndexedVector(int index1, AmidstVector vec1) {
            this.vector = vec1;
            this.index = index1;
        }
         ...
         * @return a {@link AmidstVector}.
         */
        public AmidstVector getVector() {
            return vector;
        }
         ...
         * @param vector the {@link AmidstVector} object to be set.
         */
        public void setVector(AmidstVector vector) {
            this.vector = vector;
        }
    }
