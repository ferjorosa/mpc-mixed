...
public class KeyCompoundVector<E> implements MomentParameters, NaturalParameters, SufficientStatistics, Serializable {
     ...
     * @param vector a {@link AmidstVector} object.
     */
    public void addVector(E key, AmidstVector vector){
     ...
     */
    public void setVectorByPosition(E key, AmidstVector vec) {
     ...
     */
    public AmidstVector getVectorByPosition(E key) {
    ...
    static class IndexedVector<E> {
         ...
         */
        IndexedVector(E index1, AmidstVector vec1) {
            this.vector = vec1;
            this.index = index1;
        }
