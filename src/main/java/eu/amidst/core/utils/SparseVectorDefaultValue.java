 ...
 */
public class SparseVectorDefaultValue implements AmidstVector, NaturalParameters, MomentParameters, SufficientStatistics, Serializable {
    ...
    @Override
    public boolean equalsVector(AmidstVector vector, double threshold) {
        SparseVectorDefaultValue sparseVector = (SparseVectorDefaultValue) vector;
