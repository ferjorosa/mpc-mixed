...
public final class Utils {
     ...
     * @param <E> a class extending {@link AmidstVector}.
     * @param vector the vector to be normalized.
     * @return a normalized vector.
     */
    public static <E extends AmidstVector> E normalize(E vector){
     ...
     * @return a normalized vector.
     */
    public static <E extends AmidstVector> E logNormalize(E vector){
     ...
     */
    public static double sum(AmidstVector vector){
        double sum = 0;
        for (int i=0; i<vector.size(); i++){
            sum += vector.get(i);
        }
     ...
     */
    public static int maxIndex(AmidstVector vector){
     ...
     */
    public static int minIndex(AmidstVector vector){
