...
public class GLSL_AddLatent_child implements GLSL_Operator {
    ...
    private LatentVarCounter latentVarCounter;
    ...
    public GLSL_AddLatent_child(int maxNumberOfDiscreteLatentNodes,
                                ...
                                LatentVarCounter latentVarCounter) {
        ...
        this.latentVarCounter = latentVarCounter;
    }
            ...
            if (!variable.isObservable()) {
                ...
                if (children.size() > 2) {
                    ...
                    for(Tuple2<String, String> combination: childrenCombinations) {
                        ...
                        Variable newLatentVar = copyVariables.newMultinomialVariable("gLV_" + (this.latentVarCounter.counter++), copyVariable.getNumberOfStates());
