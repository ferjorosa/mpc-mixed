...
public class GLSL_IncreaseCard implements GLSL_Operator {
    ...
    public GLSL_IncreaseCard(int maxCardinality,
    ...
    public Tuple3<String, BayesianNetwork, Double> apply(DAG dag, DataOnMemory<DataInstance> data, LogUtils.LogLevel logLevel) {
        ...
        for(Variable variable: dag.getVariables()) {
            ...
            if(!variable.isObservable()
                ...
                /* Increase the cardinality of the variable */
                ...
                LogUtils.info("IC of " + copyVariable + " to (" + newCardinality + ") -> " + result.getSecond(), logLevel);
        ...
        return new Tuple3<>("IncreaseCard", bestModel, bestModelScore);
    }
