...
public class EvaluateMissingAmidst {
    ...
    public static double nrmse(DataOnMemory<DataInstance> dataWithMissing,
        ...
        for(int j: continuousAttributesIndexes) {
            ...
            double normalizedAttributeError = attributeError;
            if(attributeError != 0.0 && (attributeMax - attributeMin) != 0)
                normalizedAttributeError = attributeError / (attributeMax - attributeMin);
