...
public class HellingerFinder {
    ...
    private double thresholdParaEM;

    private int maxCardinality;

    /** si la NMI de dos variables no supera este threshold, se consideran independientes */
    private double nmiThreshold;

    private double hellingerThreshold;

    public HellingerFinder() {
        this.thresholdParaEM = 0.5;
        this.maxCardinality = 10;
        this.nmiThreshold = 0.05;
        this.hellingerThreshold = 0.02;
    }

    public HellingerFinder(double thresholdParaEM, int maxCardinality, double nmiThreshold, double hellingerThreshold) {
        this.thresholdParaEM = thresholdParaEM;
        this.maxCardinality = maxCardinality;
        this.nmiThreshold = nmiThreshold;
        this.hellingerThreshold = hellingerThreshold;
    }

    public DiscreteBayesNet find(DiscreteData data, AbstractEM em) {
    ...
    private DiscreteVariable improveLcmHellinger(DiscreteData data,
                                                        AbstractEM em,
    ...
    private boolean lcmCanBeFormed(List<DiscreteVariable> currentVariables, Map<DiscreteVariable, Map<DiscreteVariable, Double>> pairValues) {
    ...
    private HLCM formBestLCM(DiscreteData data, AbstractEM em, List<DiscreteVariable> currentVariables, Map<DiscreteVariable, Map<DiscreteVariable, Double>> pairValues, int lcmIndex) {
     ...
     * @return
     */
    private HLCM increaseAndDecreaseCardinality(DiscreteData data, AbstractEM em, HLCM lcm) {
    ...
    private DiscreteBayesNet createInitialOLCM(DiscreteData data, AbstractEM em, Collection<HLCM> partitions) {

        DiscreteBayesNet initialOLCM = new DiscreteBayesNet(data.getName() + "_hellinger");
