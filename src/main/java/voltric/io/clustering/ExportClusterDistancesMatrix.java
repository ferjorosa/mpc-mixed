...
/**
 * Metodo simple que genera un archivo CSV con las distancias entre clusters de un modelo (por ejemplo la matrix de Hellinger)
 */
public class ExportClusterDistancesMatrix {
