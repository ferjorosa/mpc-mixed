...
import voltric.io.data.arff.ArffFileWriter;
...
/**
 * This class allows to load and save {@link Data} in different formats (CSV, ARFF, etc.).
 *
 * @author ferjorosa
 */
public class DataFileLoader {
    ...
    public static void saveDiscreteData(DiscreteData data, String filePathString) {
        try {
            selectDataFileWriter(filePathString).writeToFile(data, filePathString);
        }catch(IOException ex){
            throw new UncheckedIOException(ex);
        }
    }
    ...
    private static DataFileWriter selectDataFileWriter(String filePathString) {
