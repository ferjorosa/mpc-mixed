...
public class ArffFileWriter implements DataFileWriter {
    ...
    private void writeInstanceToFile(DiscreteDataInstance instance, FileWriter writer, String separator) throws IOException{
    ...
    private String instanceToArffString(DiscreteDataInstance instance, String separator) {
        String s = "";
