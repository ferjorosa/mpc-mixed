 ...
 */
@Deprecated
public class SimpleBifFileWriter implements ModelFileWriter {
     ...
     */
    public SimpleBifFileWriter(OutputStream output) throws UnsupportedEncodingException {
     ...
     * @throws UnsupportedEncodingException
     */
    public SimpleBifFileWriter(OutputStream output, boolean useTableFormat) throws UnsupportedEncodingException {
     ...
     * @throws UnsupportedEncodingException
     */
    public SimpleBifFileWriter(OutputStream output, boolean useTableFormat, String encoding) throws UnsupportedEncodingException {
    ...
    private void writeProbabilitiesWithStates(Function function,
        ...
        ArrayList<DiscreteVariable> order = new ArrayList<DiscreteVariable>(variables.size());
        for (int i = 1; i < variables.size(); i++)
...
/*
    private class StatePrinter implements FunctionVisitor {
