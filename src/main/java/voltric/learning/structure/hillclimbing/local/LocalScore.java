...
public class LocalScore {
    ...
    // Se usa como primer paso del LocalHillClimbing
    ...
    // Se usa en performLocalOperation
    ...
    // Se usa dentro de cada operador para ver cuanto score devuelve una operacion especifica
