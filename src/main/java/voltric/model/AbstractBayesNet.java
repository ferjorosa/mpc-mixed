...
public abstract class AbstractBayesNet<L extends AbstractBeliefNode,M extends AbstractBeliefNode>{
     ...
     */
    public boolean isEdgeAllowed(AbstractBeliefNode head, AbstractBeliefNode tail) {
        return this.dag.isEdgeAllowed(head, tail);
    }
    ...
    public boolean isForest(){
        return this.dag.isForest();
    }

    public boolean isPolyTree(){
        return this.dag.isPolyTree();
    }

    public boolean isPolyForest(){
        return this.dag.isPolyForest();
    }
