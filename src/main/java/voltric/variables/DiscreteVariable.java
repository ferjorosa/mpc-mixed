...
public class DiscreteVariable extends Variable{
     ...
     */
    @Deprecated
    // TODO: Revisar, a fecha de 18-09-2019 me he encontrado un bug al crear un LCM con 3 variables "manifest" y que al
    // crear el LCM daba excepcion, creo que por el nombre de la variable, relacionado con el instance.index
    ...
    public final boolean equals(Object object) {
        ...
        return this.name.equals(variable.name)
                // 09-07-2018: Type is commented because we need to learn from completedData where a LV is converted to MV
